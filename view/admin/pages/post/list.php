...
<body>
    ...
    <div class="content-area">
        <h2>
            Tous les Posts
            <a href="/lezm/src/controll/process/export_posts_pdf.php" class="btn btn-primary" target="_blank">📄 Exporter en PDF</a>
            <!-- Bouton de tri -->
            <?php
            ...
            <tbody>
                <?php foreach ($posts as $post): ?>
                    <tr>
                        ...
                        <td>
                            <a href="/lezm/admin/posts/edit/<?= $post['id'] ?>" class="btn btn-primary">✏️ Modifier</a>
                            <a href="/lezm/admin/posts/delete/<?= $post['id'] ?>" class="btn btn-danger" onclick="return confirm('Confirmer la suppression ?')">🗑️ Supprimer</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
