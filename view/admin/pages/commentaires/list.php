                ...
                <?php if (isset($commentairesList) && !empty($commentairesList)): ?>
                    <?php foreach ($commentairesList as $commentaire): ?>
                        <tr>
                            ...
                            <td>
                                <a href="/lezm/admin/commentaires/edit/<?= htmlspecialchars($commentaire['commentaire_id']) ?>" class="btn btn-edit">Edit</a>
                                <a href="/lezm/admin/commentaires/delete/<?= htmlspecialchars($commentaire['commentaire_id']) ?>" class="btn btn-delete" onclick="return confirm('Are you sure you want to delete this commentaire?');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
