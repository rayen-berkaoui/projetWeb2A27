<?php $active_menu = 'avis'; include_once 'C:\xampp\htdocs\lezm\view\admin\partials\sidebar.php'; ?>
...
<head>
    ...
    <style>
        /* Form styling same as evenement form */
...
<body>
    <div class="content-area">
        <h2>Create New Avis</h2>
        <form method="POST" action="/lezm/admin/avis/create">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary">Create Avis</button>
            </div>
        </form>
    </div>
</body>
