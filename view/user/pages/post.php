<?php
require_once 'C:\xampp\htdocs\lezm\view\user\pages\layout\header.php';
...
if ($postId === 0) {
    echo "Invalid post.";
    require_once 'C:\xampp\htdocs\lezm\view\user\pages\layout\footer.php';
    exit;
}
...
<?php require_once 'C:\xampp\htdocs\lezm\view\user\pages\layout\footer.php'; ?>
