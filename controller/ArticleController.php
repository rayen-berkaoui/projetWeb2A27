<?php
require_once 'C:\xampp\htdocs\lezm\src\domain\ArticleType.php';
class ArticleController {
    ...
    public function edit($id) {
        ...
        include 'C:\xampp\htdocs\lezm\view\admin\pages\articles\edit.php';
    }
    ...
    public function createType() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            header("Location: /lezm/admin/articles/listTypes");
            exit;
        }

        // Include the view to display the create type form
        include 'C:\xampp\htdocs\lezm\view\admin\pages\articles\createType.php';
    }
    public function listTypes() {
        ...
        require_once  'C:\xampp\htdocs\lezm\view\admin\pages\articles\listType.php'; // Adjust path if necessary
    }
    ...
    public function editType($id) {
        ...
        if ($type) {
            ...
            require_once 'C:\xampp\htdocs\lezm\view\admin\pages\articles\editType.php';
        } else {
            // Type not found
            header("Location: /lezm/admin/articles/listTypes");
            exit();
