...
class EvenementController {
    ...
    public function createEvenement() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            header("Location: /lezm/admin/evenements");
            exit;
        }

        include 'C:\xampp\htdocs\lezm\view\admin\pages\evenements\create.php';
    }
    ...
    public function editEvenement($id) {
        ...
        include 'C:\xampp\htdocs\lezm\view\admin\pages\evenements\edit.php';
    }
    ...
    public function indexReservations() {
        ...
        include 'C:\xampp\htdocs\lezm\view\admin\pages\reservations\list.php';
    }
    ...
    public function createReservation() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            header("Location: /lezm/admin/reservations");
            exit;
        }
        ...
        include 'C:\xampp\htdocs\lezm\view\admin\pages\reservations\create.php';
    }
    ...
    public function editReservation($id) {
        ...
        include 'C:\xampp\htdocs\lezm\view\admin\pages\reservations\edit.php';
    }
    ...
    public function publicReserveForm($eventId) {
        ...
        include 'C:\xampp\htdocs\lezm\view\user\events\reserve.php'; // You should create this view
    }
    public function submitPublicReservation() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            header("Location: /lezm/events"); // Or back to a confirmation page
            exit;
        }
    }
