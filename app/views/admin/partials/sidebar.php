...
">
    ...
    <nav>
        <ul style="list-style: none; padding: 0; margin: 0;">
            ...
            <li style="margin-bottom: 10px;">
                <a href="/lezm/admin/marketing" style="
                    display: block;
            ...
            <li style="margin-bottom: 10px;">
                <a href="/lezm/admin/forums" style="
                    display: block;
            ...
            <li style="margin-bottom: 10px;">
                <a href="/lezm/admin/articles" style="
                    display: block;
                ...
                <ul style="list-style: none; padding-left: 20px; margin: 10px 0 0 0;">
                    ...
                    <li style="margin-bottom: 5px;">
                        <a href="/lezm/admin/articles/create" style="
                            display: block;
            ...
            <li style="margin-bottom: 10px;">
                <a href="/lezm/admin/evenements" style="
                    display: block;
