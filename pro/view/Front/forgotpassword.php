<?php
session_start();
require 'C:\xampp\htdocs\2A27\pro\model\user.php';
require 'C:\xampp\htdocs\2A27\pro\controler\userc.php';
...
<head>
    ...
    <link rel="stylesheet" href="http://<?= $_SERVER['HTTP_HOST'] ?>/2A27/pro/view/assets/css/styles.css">
</head>
<body>
    <div class="container">
        ...
        <a href="2A27/login" class="back-btn">Retour à la connexion</a>
    </div>
