...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_profile'])) {
    ...
    if ($newUsername === '' || $newEmail === '' || $newNumero === '') {
        ...
        try {
            ...
            header('Location: /lezm/profile'); // Redirige vers l'URL propre
            exit();
        } catch (PDOException $e) {
...
<head>
  ...
  <link rel="stylesheet" href="http://<?= $_SERVER['HTTP_HOST'] ?>/lezm/pro/view/assets/css/profile.css">
  <style>
  .home-btn {
    position: absolute;
    top: 20px;
...
<body>
    <a href="/lezm/home" class="home-btn">🏠 Accueil</a>
  <div class="profile-container">
    ...
    <form method="POST" action="/lezm/profile">
