...
require_once('C:/xampp/htdocs/lezm/pro/controler/userc.php');
...
function generatePassword($length = 12) {
    ...
    $password = '';
    for ($i = 0; $i < $length; $i++) {
        // Utilisation de mt_rand() si random_int() n'est pas disponible
...
<head>
    ...
    <link rel="stylesheet" href="http://<?= $_SERVER['HTTP_HOST'] ?>/lezm/pro/view/assets/css/l2.css">
                ...
                <div class="form sign-up">
                    <form id="signupForm" method="POST" action="">
                        <div class="input-group">
                            ...
                            <input type="text" name="username" id="signupUsername" placeholder="Nom d'utilisateur" value="<?= htmlspecialchars(isset($_POST['username']) ? $_POST['username'] : '') ?>">
                            <span id="signupUsernameError" class="error-message"></span>
                        </div>
                        <div class="input-group">
                            <i class="bx bx-mail-send"></i>
                            <input type="email" name="email" id="signupEmail" placeholder="Email" value="<?= htmlspecialchars(isset($_POST['email']) ? $_POST['email'] : '') ?>">
...
<script src="http://<?= $_SERVER['HTTP_HOST'] ?>/lezm/pro/view/assets/js/l2.js" defer></script>
<script>
